...
# Render'da session verisini environment variable'dan al
session_data = os.getenv('SESSION_DATA')

# session_data null olmamalı
if session_data is None:
    print("Session verisi bulunamadı. Lütfen Render settings bölümünü kontrol edin.")
    exit()

# session verisini 'my_session.session' dosyasına yaz
with open('my_session.session', 'w') as file:
    file.write(session_data)

# TelegramClient ile başlat
